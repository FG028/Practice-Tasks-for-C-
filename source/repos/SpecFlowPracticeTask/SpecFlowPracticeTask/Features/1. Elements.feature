Feature: 1 Interact with form elements on DemoQA
...
Scenario: 1.2. Expand and Select Folders
    ...
    Then I expand the Office folder 
        ...
        And I select the entire folder
...
Scenario: 1.3. Sort and delete row in Web Tables
    ...
    Then I should see the values in the "Salary" column are in ascending order
        ...
        And I should see there are only two rows left in the table
    Then I should not see the value "Compliance" among the values in the "Department" column
